...
| Attachment under `suballocation` | [Attachment under suballocation](../../../modules/vulkan/renderpass/vktRenderPassTests.cpp#L8565) | Attaches the `subpass_dependencies` group under `suballocation` for every rendering variant. |

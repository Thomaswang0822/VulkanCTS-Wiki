...
| `colorspace` test case leaf | `extensions`, `basic`, `hdr` | Selects enumeration-only checking, rendered swapchain coverage, or rendered coverage with HDR metadata. | [createColorSpaceTests](../../../modules/vulkan/wsi/vktWsiColorSpaceTests.cpp#L696-L709) |

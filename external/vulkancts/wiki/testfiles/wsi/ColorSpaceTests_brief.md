...
|-------|-------------|----------------|
| Extension instance setup | [createInstanceWithWsi](../../../modules/vulkan/wsi/vktWsiColorSpaceTests.cpp#L104-L109) | Enables `VK_EXT_swapchain_colorspace` when advertised. |
| Device extension setup | [createDeviceWithWsi](../../../modules/vulkan/wsi/vktWsiColorSpaceTests.cpp#L118-L144) | Requires `VK_KHR_swapchain` and optionally enables `VK_EXT_hdr_metadata`. |
| Swapchain parameters | [getBasicSwapchainParameters](../../../modules/vulkan/wsi/vktWsiColorSpaceTests.cpp#L229-L286) | Places the selected `VkColorSpaceKHR` in `VkSwapchainCreateInfoKHR`. |
...
| Color-space comparison | [colorspaceCompareTest](../../../modules/vulkan/wsi/vktWsiColorSpaceTests.cpp#L393-L527) | Defines the per-format comparison flow and exact pass/fail check. |

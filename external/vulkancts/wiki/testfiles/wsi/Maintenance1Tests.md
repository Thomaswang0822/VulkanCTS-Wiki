...
|-------------|------|----------------|
| Extension selection and feature setup | [`chooseExt`, `createInstanceWithWsi`, and `createDeviceWithWsi`](../../../modules/vulkan/wsi/vktWsiMaintenance1Tests.cpp#L75-L95) | Establishes KHR/EXT fallback, required extensions, and feature enabling. |

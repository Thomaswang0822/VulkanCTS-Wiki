...
| Multi-viewport helper | [`createScissorMultiViewportTests()`](../../../modules/vulkan/fragment_ops/vktFragmentOperationsScissorMultiViewportTests.cpp#L442-L451) | Registers `scissor_1` through `scissor_16` and checks support. |

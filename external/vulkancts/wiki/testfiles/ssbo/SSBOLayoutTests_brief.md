...
| Reference layout and shader generation | [`delayedInit()`](../../../modules/vulkan/ssbo/vktSSBOLayoutCase.cpp#L2823-L2860) | Establishes reference data and generated compute source |
...
| Host execution and comparison | [`SSBOLayoutCaseInstance::iterate()`](../../../modules/vulkan/ssbo/vktSSBOLayoutCase.cpp#L2297-L2676) | Binds buffers, dispatches, barriers, reads back, and returns status |

...
| Render target | 16 × 16 pixels, `VK_FORMAT_R8G8B8A8_UNORM` | Bounds the color target and storage-buffer indexing workload. | [`WIDTH`/`HEIGHT`](../../../modules/vulkan/draw/vktDrawExplicitVertexParameterTests.cpp#L75-L79), image creation [vktDrawExplicitVertexParameterTests.cpp](../../../modules/vulkan/draw/vktDrawExplicitVertexParameterTests.cpp#L356-L379) |

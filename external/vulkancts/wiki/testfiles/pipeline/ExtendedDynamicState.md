...
| Dynamic state property | EDS1, EDS2, EDS3, and related extension-state leaves | Selects the fixed-function state being compared, such as cull mode, depth compare op, stencil operation, topology, viewport, blend equation, or sample mask. | [test registration](../../../modules/vulkan/pipeline/vktPipelineExtendedDynamicStateTests.cpp#L7034-L7054) |

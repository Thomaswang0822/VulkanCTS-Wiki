...
| Sampler setup and comparison | [`setup`, `verifyImage`, and `iterate`](../../../modules/vulkan/pipeline/vktPipelineAttachmentFeedbackLoopLayoutTests.cpp#L415-L1852) | Sets up the sampled attachment, submits the draw, reads it back, and compares it. |

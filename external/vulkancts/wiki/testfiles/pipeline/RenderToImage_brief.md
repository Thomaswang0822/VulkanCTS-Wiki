...
| Mipmap runtime and oracle | [`testRenderToMipMaps()`](../../../modules/vulkan/pipeline/vktPipelineRenderToImageTests.cpp#L1512-L1777) | Transitions, copies, and compares each mip level. |
| Case generation and registration | [`addTestCasesWithFunctions()` and `createRenderToImageTests()`](../../../modules/vulkan/pipeline/vktPipelineRenderToImageTests.cpp#L1852-L2029) | Defines the matrix and registers `core` plus `dedicated_allocation`. |

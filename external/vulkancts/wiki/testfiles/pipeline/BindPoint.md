...
| Graphics state binding | [`GraphicsPipelineWrapper::bind`](../../../framework/vulkan/vkPipelineConstructionUtil.cpp#L4740-L4781) | Shows that shader-object variants bind graphics shader objects and dynamic state instead of a graphics pipeline. |

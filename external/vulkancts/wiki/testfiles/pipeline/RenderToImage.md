...
|-----------|-------------------|----------------------|----------|
| Direct intermediate node | `core`, `dedicated_allocation` | Selects suballocated or dedicated allocation for the test's images and buffers. | [`createRenderToImageTests()`](../../../modules/vulkan/pipeline/vktPipelineRenderToImageTests.cpp#L2014-L2029), [resource allocation](../../../modules/vulkan/pipeline/vktPipelineRenderToImageTests.cpp#L1022-L1079) |

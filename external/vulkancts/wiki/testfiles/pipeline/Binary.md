...
|-------------|------|----------------|
| Category registration | [`createChildren`](../../../modules/vulkan/pipeline/vktPipelineTests.cpp#L95-L223) | Creates and populates the `pipeline_binary` category for eligible construction types |
...
| Basic graphics/data matrix | [`createPipelineBlobTestsInternal`](../../../modules/vulkan/pipeline/vktPipelineCacheTests.cpp#L2324-L2489) | Defines the graphics stage chains, retrieved-data family, and monolithic compute gating |

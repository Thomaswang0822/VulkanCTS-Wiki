...
| Execution and output check | [`iterate()` submission and validation](../../../modules/vulkan/pipeline/vktPipelineNoQueuesTests.cpp#L614-L1706) | Submits the second-pass work and checks output values. |

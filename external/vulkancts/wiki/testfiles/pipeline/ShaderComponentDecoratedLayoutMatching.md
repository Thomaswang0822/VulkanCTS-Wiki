...
- This page covers the implementation behind `pipeline.<construction>.interface_matching.shader_layout_component_matching`, registered by [`createShaderCompDecorLayoutMatchingTests()`](../../../modules/vulkan/pipeline/vktPipelineShaderComponentDecoratedLayoutMatchingTests.cpp#L1175-L1253).
...
- [`verifyResult()`](../../../modules/vulkan/pipeline/vktPipelineShaderComponentDecoratedLayoutMatchingTests.cpp#L945-L968) scans every pixel. It passes only when each pixel equals `tcu::Vec4(0.125f, 0.25f, 0.5f, 1.0f)`; otherwise it reports the first mismatch and logs the result image.
...
|-------------|------|----------------|
| Registration entrypoint | [`createShaderCompDecorLayoutMatchingTests()`](../../../modules/vulkan/pipeline/vktPipelineShaderComponentDecoratedLayoutMatchingTests.cpp#L1175-L1253) | Builds the four stage-flow families and the parameter matrix. |

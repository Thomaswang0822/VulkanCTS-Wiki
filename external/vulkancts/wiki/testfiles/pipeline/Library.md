...
| Pseudorandom case seed | `case_0` through `case_9`, each with or without `_io_ssbo_first` | Selects the seeded descriptor content, binding counts, and set-index assignment per stage ([case generation](../../../modules/vulkan/util/vktIndependentSetsUtil.cpp#L342-L409)). |

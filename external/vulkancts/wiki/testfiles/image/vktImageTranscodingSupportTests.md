...
|---|---|---|
| Image type | `IMAGE_TYPE_2D` (fixed) | [Line 1244](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1244) |
| Image size | `UVec3(16u, 16u, 1u)` (fixed) | [Line 1243](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1243) |
| Format families | 8-bit, 16-bit, 24-bit, 32-bit, 48-bit, 64-bit, 96-bit, 128-bit, 192-bit, 256-bit | [Lines 1173-1178](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1173-L1178) |
| Tested image usage | Input attachment, color attachment, sampled, storage (per operation) | [Lines 1188-1193](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1188-L1193) |
| Base flags | `VK_IMAGE_USAGE_TRANSFER_SRC_BIT \| VK_IMAGE_USAGE_TRANSFER_DST_BIT` | [Line 1201](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1201) |

## Support / Feature Requirements

| Feature / Extension | When it applies | Evidence |
|---|---|---|
| `VK_KHR_maintenance2` | All extended usage bit tests | [Line 1089](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1089) |
| `fragmentStoresAndAtomics` | `texture_read` and `texture_write` operations | [Lines 1091-1093](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1091-L1093) |
| Format support check | All tests verify format supports required usage flags | [Lines 1095-1100](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1095-L1100) |
...
- **Memory comparison:** Uses 64-bit word comparison to detect any data corruption during transcoding ([Lines 717-748](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L717-L748))
...
- SRGB formats are skipped due to shader layout classifier limitations ([Line 1225-1226](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1225-L1226))
- Packed formats are skipped due to shader layout classifier limitations ([Lines 1229-1230](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1229-L1230))
- Swizzled component formats (e.g., bgr) are skipped ([Lines 1233-1234](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1233-L1234))
- Three-component formats are skipped ([Lines 1237-1238](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1237-L1238))
- Compressed formats are skipped ([Lines 1212-1219](../../../modules/vulkan/image/vktImageTranscodingSupportTests.cpp#L1212-L1219))

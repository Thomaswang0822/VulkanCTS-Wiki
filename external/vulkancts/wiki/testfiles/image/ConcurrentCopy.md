...
| Array-compatible image flag | [Array-compatible image flag](../../../../vulkan-docs/src/chapters/resources.adoc#L4160-L4162) | States that `VK_IMAGE_CREATE_2D_ARRAY_COMPATIBLE_BIT` permits 2D and 2D-array image views. |
| Slice-scoped barrier semantics | [Slice-scoped barrier semantics](../../../../vulkan-docs/src/chapters/synchronization.adoc#L7523-L7531) | Defines `maintenance9` handling for barrier subresource ranges on 2D-array-compatible 3D images. |

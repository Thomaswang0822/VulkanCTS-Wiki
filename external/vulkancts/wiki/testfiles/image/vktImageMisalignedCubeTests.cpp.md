...
|---|---|---|
| Image type | `VK_IMAGE_TYPE_2D` with `VK_IMAGE_CREATE_CUBE_COMPATIBLE_BIT` | [Lines 66-67](file:///f:/repos/VK-GL-CTS/external/vulkancts/modules/vulkan/image/vktImageMisalignedCubeTests.cpp#L66-L67) |
| Cube dimensions | 16x16 pixels per cube face | [Line 386](file:///f:/repos/VK-GL-CTS/external/vulkancts/modules/vulkan/image/vktImageMisalignedCubeTests.cpp#L386) |
| Array layers | 7, 8, 9, 10, 11 layers | [Lines 385-387](file:///f:/repos/VK-GL-CTS/external/vulkancts/modules/vulkan/image/vktImageMisalignedCubeTests.cpp#L385-L387) |
| Format | `VK_FORMAT_R8G8B8A8_UNORM` (fixed) | [Line 396](file:///f:/repos/VK-GL-CTS/external/vulkancts/modules/vulkan/image/vktImageMisalignedCubeTests.cpp#L396) |
| Image usage | `VK_IMAGE_USAGE_STORAGE_BIT \| VK_IMAGE_USAGE_SAMPLED_BIT \| VK_IMAGE_USAGE_TRANSFER_SRC_BIT \| VK_IMAGE_USAGE_TRANSFER_DST_BIT` | [Lines 61-62](file:///f:/repos/VK-GL-CTS/external/vulkancts/modules/vulkan/image/vktImageMisalignedCubeTests.cpp#L61-L62) |
| Cube 0 base layer | Layer 0 (always aligned) | [Line 157](file:///f:/repos/VK-GL-CTS/external/vulkancts/modules/vulkan/image/vktImageMisalignedCubeTests.cpp#L157) |
| Cube 1 base layer | `numLayers - 6` (misaligned) | [Line 158](file:///f:/repos/VK-GL-CTS/external/vulkancts/modules/vulkan/image/vktImageMisalignedCubeTests.cpp#L158) |

## Support / Feature Requirements

| Feature / Extension | When it applies | Evidence |
|---|---|---|
| `VK_IMAGE_CREATE_CUBE_COMPATIBLE_BIT` | All misaligned cube tests | Image creation flags at [Line 66](file:///f:/repos/VK-GL-CTS/external/vulkancts/modules/vulkan/image/vktImageMisalignedCubeTests.cpp#L66) |

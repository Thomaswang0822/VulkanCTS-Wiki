...
- **Swapchain tests require format support from the surface.** Tests verify that both image format and view format are advertised by the swapchain surface format enumeration.

...
| Input-attachment execution and programs | [`InputAttachmentTestInstance::iterate()`](../../../modules/vulkan/image/vktImageGeneralLayoutTests.cpp#L1143-L1667), [`initPrograms()`](../../../modules/vulkan/image/vktImageGeneralLayoutTests.cpp#L1752-L1791) | Shows the two-pass alternatives and byte-level result check. |
| MSAA execution and programs | [`MsaaTestInstance::iterate()`](../../../modules/vulkan/image/vktImageGeneralLayoutTests.cpp#L1760-L2186), [`initPrograms()`](../../../modules/vulkan/image/vktImageGeneralLayoutTests.cpp#L2266-L2300) | Shows attachment construction, resolution, and coordinate validation. |
| Registration matrix | [`createImageGeneralLayoutTests()`](../../../modules/vulkan/image/vktImageGeneralLayoutTests.cpp#L2253-L2370) | Defines every registered family and parameter dimension. |

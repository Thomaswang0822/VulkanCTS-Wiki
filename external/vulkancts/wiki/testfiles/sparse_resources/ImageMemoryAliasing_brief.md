...
| Dispatcher registration | [`createSparseResourcesTests`](../../../modules/vulkan/sparse_resources/vktSparseResourcesTests.cpp#L45-L68) | Confirms both aliasing test families are children of `sparse_resources`. |

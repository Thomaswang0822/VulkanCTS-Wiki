...
| Format | `getTestFormats(imageType)` | Changes plane count, alignment, sparse requirements, and copy extents. YCbCr formats are limited by the shared helper. | [`getTestFormats()`](../../../modules/vulkan/sparse_resources/vktSparseResourcesTestsUtil.cpp#L54-L120) |

...
| Memory objects | Two, `kMemoryObjectCount = 2` | Supplies the two clear colors used to detect which binding backs each texel. | [`kMemoryObjectCount`](../../../modules/vulkan/sparse_resources/vktSparseResourcesImageRebind.cpp#L89), [`getColorClearValue`](../../../modules/vulkan/sparse_resources/vktSparseResourcesImageRebind.cpp#L162-L192) |

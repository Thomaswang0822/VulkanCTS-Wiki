...
| Helper buffer size | `2^10`, `2^12`, `2^16`, `2^17`, `2^20`, `2^24` in the binding, aliasing, and residency helpers; `2^16`, `2^18`, `2^20`, `2^24` for rebind | Changes the number and layout of sparse blocks exercised | [`addBufferSparseBindingTests()`](../../../modules/vulkan/sparse_resources/vktSparseResourcesBufferSparseBinding.cpp#L348-L356), [`addBufferSparseRebindTests()`](../../../modules/vulkan/sparse_resources/vktSparseResourcesBufferRebind.cpp#L412-L418) |
...
| Sparse binding helper | [Sparse binding helper](../../../modules/vulkan/sparse_resources/vktSparseResourcesBufferSparseBinding.cpp#L149-L356) | Tests copy-in/copy-out binding cases |
| Sparse residency and texel cases | [Sparse residency and texel cases](../../../modules/vulkan/sparse_resources/vktSparseResourcesBufferSparseResidency.cpp#L1120-L1884) | Tests holes, commands, and sparse texel operations |
| Sparse memory aliasing | [`BufferSparseMemoryAliasingInstance::iterate()`](../../../modules/vulkan/sparse_resources/vktSparseResourcesBufferMemoryAliasing.cpp#L246-L439) | Tests shared memory through two sparse buffers |
| Sparse rebind | [Sparse rebind](../../../modules/vulkan/sparse_resources/vktSparseResourcesBufferRebind.cpp#L23-L418) | Tests partial rebinding and final contents |
| Queue and device setup | [`SparseResourcesBaseInstance::createDeviceSupportingQueues()`](../../../modules/vulkan/sparse_resources/vktSparseResourcesBase.cpp#L88-L194) | Selects sparse, graphics, compute, and device-group support |

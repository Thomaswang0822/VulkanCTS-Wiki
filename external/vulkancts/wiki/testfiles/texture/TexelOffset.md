...
The default Vulkan mustpass contains the single executable path `dEQP-VK.texture.texel_offset.texel_offset` ([mustpass entry](../../../mustpass/main/vk-default/texture.txt#L25669)).

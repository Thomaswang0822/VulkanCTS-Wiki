...
| Amber support and execution | [`AmberTestCase::checkSupport`](../../../modules/vulkan/amber/vktAmberTestCase.cpp#L204-L287), [`AmberTestInstance::iterate`](../../../modules/vulkan/amber/vktAmberTestCase.cpp#L546-L615) | Checks image/buffer format support, executes the Vulkan recipe, and maps Amber success to CTS status. |
| Mustpass inventory | [`vk-default/texture.txt`](../../../mustpass/main/vk-default/texture.txt#L25646-L25668) | Lists the exact 23 default Vulkan test paths. |

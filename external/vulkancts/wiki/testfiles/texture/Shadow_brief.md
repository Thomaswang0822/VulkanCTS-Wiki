...
| Shader generator | [`initializePrograms()`](../../../modules/vulkan/texture/vktTextureTestUtil.cpp#L209-L759) | Specializes sampler types, coordinate forms, and Dref lookup signatures. |
| Image backing and upload | [`TextureBinding::updateTextureData()`](../../../modules/vulkan/texture/vktTextureTestUtil.cpp#L807-L920) | Creates regular or sparse images and uploads them for shader reads. |

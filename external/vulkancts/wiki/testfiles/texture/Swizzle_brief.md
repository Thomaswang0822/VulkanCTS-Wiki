...
| Image backing and view mapping | [`TextureBinding::updateTextureData` and `updateTextureViewMipLevels`](../../../modules/vulkan/texture/vktTextureTestUtil.cpp#L807-L968) | Creates regular or sparse images, uploads data, chooses the aspect, and installs `VkComponentMapping`. |

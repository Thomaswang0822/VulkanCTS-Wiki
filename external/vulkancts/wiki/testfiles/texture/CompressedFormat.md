...
| 2D case generation | [`populateTextureCompressedFormatTests`](../../../modules/vulkan/texture/vktTextureCompressedFormatTests.cpp#L610-L662) | Generates common, sparse, compute-marked, and ASTC void-extent 2D leaves. |
| 3D case generation | [`populate3DTextureCompressedFormatTests`](../../../modules/vulkan/texture/vktTextureCompressedFormatTests.cpp#L664-L725) | Generates common-format and native ASTC 3D leaves. |
...
| Graphics and compute shader generation | [`initializePrograms`](../../../modules/vulkan/texture/vktTextureTestUtil.cpp#L209-L759) | Specializes `sampler2D` or `sampler3D` graphics shaders and the shared compute template. |

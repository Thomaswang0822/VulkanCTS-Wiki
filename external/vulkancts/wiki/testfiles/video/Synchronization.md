...
| Semaphore case set | [createBasicBinarySemaphoreTests and createBasicTimelineSemaphoreTests](../../../modules/vulkan/synchronization/vktSynchronizationBasicSemaphoreTests.cpp#L874-L948) | Registers the binary and timeline semaphore leaves per API family. |

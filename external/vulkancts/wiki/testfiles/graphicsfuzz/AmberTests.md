...
| Requirement support and consistency | [`checkSupport()`](../../../modules/vulkan/amber/vktAmberTestCase.cpp#L203-L286), [`validateRequirements()`](../../../modules/vulkan/amber/vktAmberTestCase.cpp#L648-L698) | Checks indexed support gates and provides the index-versus-recipe consistency audit path. |

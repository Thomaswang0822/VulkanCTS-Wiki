...
| Read operation and shader stage | `READ_COPY_BUFFER` removes this shader path; another shader-access operation or stage would change the generated prefix, required passthrough stages, and the stage receiving the SSBO declarations and loop. | [`initPassthroughPrograms`](../../../modules/vulkan/synchronization/vktSynchronizationOperation.cpp#L2273-L2406) |

...
| Layout test execution | [`CooperativeVectorLayoutTestInstance::iterate`](../../../../vulkancts/modules/vulkan/cooperative_vector/vktCooperativeVectorMatrixTests.cpp#L168-L412) | Generates matrix bytes, performs conversions, synchronizes device work, and checks values. |
...
| Type test execution | [`CooperativeVectorTypeConversionTestInstance::iterate`](../../../../vulkancts/modules/vulkan/cooperative_vector/vktCooperativeVectorMatrixTests.cpp#L610-L840) | Queries optimal size, generates representations, converts data, and checks quantized values. |
...
| Package registration | [`cooperative_vector` root](../../../../vulkancts/modules/vulkan/vktTestPackage.cpp#L1454-L1456) | Places the category in the Vulkan test package. |

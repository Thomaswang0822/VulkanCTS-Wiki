...
- `initPrograms` adds the source-controlled `ShaderBuildOptions` with SPIR-V 1.4 for the test shader [vktCooperativeVectorBasicTests.cpp](../../../modules/vulkan/cooperative_vector/vktCooperativeVectorBasicTests.cpp#L1645-L1668).
...
- The generated source uses byte offsets for NV cooperative-vector loads and stores. The host allocates padded vectors and supplies the matching byte-stride values [vktCooperativeVectorBasicTests.cpp](../../../modules/vulkan/cooperative_vector/vktCooperativeVectorBasicTests.cpp#L728-L745).
...
| Factory and operation matrix | [createCooperativeVectorBasicTests#L3961-L4224](../../../modules/vulkan/cooperative_vector/vktCooperativeVectorBasicTests.cpp#L3961-L4224) | Defines names, generated dimensions, and basic-family pruning. |
| Support and property checks | [CooperativeVectorTestCase::checkSupport#L347-L535](../../../modules/vulkan/cooperative_vector/vktCooperativeVectorBasicTests.cpp#L347-L535) | Enforces feature, limit, advertised-combination, and shared-memory-fit requirements. |
| Type and extension generation | [makeVecType and initPrograms#L564-L692](../../../modules/vulkan/cooperative_vector/vktCooperativeVectorBasicTests.cpp#L564-L692) | Distinguishes `coopvecNV` from `vector` and emits declarations. |
| Operation emission | [operation switch#L1238-L1347](../../../modules/vulkan/cooperative_vector/vktCooperativeVectorBasicTests.cpp#L1238-L1347) | Emits the selected basic operation. |
| Runtime resources | [iterate setup#L1848-L2404](../../../modules/vulkan/cooperative_vector/vktCooperativeVectorBasicTests.cpp#L1848-L2404) | Allocates, initializes, binds, and specializes resources. |
| Result checks | [iterate checking#L3042-L3492](../../../modules/vulkan/cooperative_vector/vktCooperativeVectorBasicTests.cpp#L3042-L3492) | Computes references and applies source-defined comparison rules. |

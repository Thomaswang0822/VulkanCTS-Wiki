...
| Runtime path selection | [`test`](../../../modules/vulkan/subgroups/vktSubgroupsBallotBroadcastTests.cpp#L378-L453) | Defines input layout and selects compute, mesh, graphics, or ray tracing helpers. |
...
| Compute execution and readback | [`makeComputeOrMeshTestRequiredSubgroupSize`](../../../modules/vulkan/subgroups/vktSubgroupsTestsUtils.cpp#L3764-L4068) | Creates resources, dispatches each local-size variant, synchronizes, and calls the checker. |

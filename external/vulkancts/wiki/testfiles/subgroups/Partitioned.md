...
| Family-specific runtime routing | [`noSSBOtest` and `test`](../../../modules/vulkan/subgroups/vktSubgroupsPartitionedTests.cpp#L402-L518) | Routes cases to framebuffer, compute, graphics, ray tracing, mesh, or task harnesses and subgroup-size sweeps. |

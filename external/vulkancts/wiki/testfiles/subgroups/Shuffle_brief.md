...
| Resource setup and dispatch routing | [`noSSBOtest()` and `test()`](../../../modules/vulkan/subgroups/vktSubgroupsShuffleTests.cpp#L484-L653) | Shows input sizes, resource kinds, stage helpers, and required-size sweeps. |

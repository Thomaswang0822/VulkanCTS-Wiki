...
| Runtime dispatch selection | [`noSSBOtest` and `test`](../../../modules/vulkan/subgroups/vktSubgroupsPartitionedTests.cpp#L402-L518) | Routes each registered family to the relevant common harness. |

...
|-------------|------|----------------|
| `createMeshShaderSmokeTests` | [smoke test registration](../../../modules/vulkan/mesh_shader/vktMeshShaderSmokeTests.cpp#L1137-L1152) | Registers the six smoke children and binds gradient parameters. |
| Triangle case support and shader setup | [triangle support and shader setup](../../../modules/vulkan/mesh_shader/vktMeshShaderSmokeTests.cpp#L97-L338) | Defines support gates and mesh/task/fragment shader sources. |
| Triangle case data | [triangle case data](../../../modules/vulkan/mesh_shader/vktMeshShaderSmokeTests.cpp#L341-L382) | Selects coordinates, indices, task counts, and expected colors. |
| `MeshTriangleRenderer::iterate` | [triangle rendering and validation](../../../modules/vulkan/mesh_shader/vktMeshShaderSmokeTests.cpp#L385-L545) | Builds resources and pipeline, draws mesh tasks, copies the image, and checks solid color. |
| `initGradientPrograms` | [gradient shader generation](../../../modules/vulkan/mesh_shader/vktMeshShaderSmokeTests.cpp#L547-L922) | Generates the gradient shaders and the direct SPIR-V shading-rate variant. |
| `testFullscreenGradient` | [gradient rendering and validation](../../../modules/vulkan/mesh_shader/vktMeshShaderSmokeTests.cpp#L934-L1133) | Builds the gradient reference image and performs block validation. |
| `checkTaskMeshShaderSupportNV` | [mesh shader support checks](../../../modules/vulkan/mesh_shader/vktMeshShaderUtil.cpp#L111-L124) | Requires `VK_NV_mesh_shader` and the requested task or mesh feature bits. |

...
- The default `ShaderRenderCaseInstance` path uses fuzzy comparison. `iterate()` compares the rendered and reference images with error threshold `0.2f`, returning `pass("Result image matches reference")` or `fail("Image mismatch")` ([comparison selection](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L658-L683), [image comparison](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L799-L805), [`compareImages()`](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L2721-L2727)).

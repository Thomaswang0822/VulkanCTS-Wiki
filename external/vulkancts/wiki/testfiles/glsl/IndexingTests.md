...
| Shared execution and comparison | [`ShaderRenderCase`](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L607-L632), [`iterate()`](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L773-L805), and [`compareImages()`](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L2721-L2727) | Compiles the shaders, renders the quad, computes the reference, and reports the image result. |

...
| Common function | `abs`, `sign`, `isnan`, `isinf`, `floatbitstoint`, `floatbitstouint`, `intbitstofloat`, `uintbitstofloat`, `clamp_const_array_dynamic_index` | Selects a scalar, vector, classification, bit reinterpretation, or constant-array dynamic-indexing operation. | [`vktShaderCommonFunctionTests.cpp`](../../../modules/vulkan/shaderexecutor/vktShaderCommonFunctionTests.cpp#L1197-L1229) |
...
| FConvert type pair | Regular Vulkan builds: E5M2, E4M3, E2M1, E3M2, E2M3, UE8M0, MXINT8, bfloat16, float16, float32, float64, plus signed and unsigned 32-bit integer conversions; Vulkan SC: float16, float32, float64 and integer conversions | Selects the source and destination representation. Same-type pairs are removed; conversions are filtered by implementation support, and supported saturated cases are restricted to E5M2/E4M3 destinations with non-FP8 sources. Additional bitcast-extract variants are generated for E2M1, E3M2, and E2M3 sources. | [`vktShaderFConvertTests.cpp`](../../../modules/vulkan/shaderexecutor/vktShaderFConvertTests.cpp#L1884-L1973) |

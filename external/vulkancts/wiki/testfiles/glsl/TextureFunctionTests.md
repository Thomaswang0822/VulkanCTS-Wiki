...
- `TexLookupEvaluator` calls the table-selected CPU evaluator for each reference sample. The shared shader-render instance executes the graphics draw or compute dispatch, builds the matching reference image, and returns pass only when image comparison succeeds ([evaluator](../../../modules/vulkan/shaderrender/vktShaderRenderTextureFunctionTests.cpp#L1409-L1429), [shared iteration](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L773-L805), [comparison selection](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L2721-L2727)).
...
| Stage and sparse case expansion | [`createCaseGroup()`](../../../modules/vulkan/shaderrender/vktShaderRenderTextureFunctionTests.cpp#L4977-L5036) | Converts each case-table row into supported stage and sparse leaves. |
| Test-family registration | [`ShaderTextureFunctionTests::init()`](../../../modules/vulkan/shaderrender/vktShaderRenderTextureFunctionTests.cpp#L5038-L8366) | Defines samplers, textures, lookup tables, offset loops, and query children. |
...
| Shared image oracle | [`ShaderRenderCaseInstance::iterate()`](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L774-L807), [`compareImages()`](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L2714-L2724) | Executes the regular render/compute path, builds the reference image, and returns pass or image mismatch. |

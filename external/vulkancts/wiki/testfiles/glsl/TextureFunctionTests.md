...
| Shared image oracle | [`ShaderRenderCaseInstance::iterate()`](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L773-L805), [`compareImages()`](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L2721-L2727) | Executes the regular render/compute path, builds the reference image, and returns pass or image mismatch. |

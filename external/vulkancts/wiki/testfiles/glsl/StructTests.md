...
| Shared uniform setup | [`addUniform()` and `useUniform()`](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L859-L1059), [`useUniform()` values](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L946-L1059) | Defines descriptor-backed data upload and predefined scalar controls. |
| Shared execution and oracle | [`ShaderRenderCaseInstance::iterate()`](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L774-L807), [reference and comparison](../../../modules/vulkan/shaderrender/vktShaderRender.cpp#L2603-L2727) | Renders, computes the stage-specific reference image, compares images, and returns pass or fail. |

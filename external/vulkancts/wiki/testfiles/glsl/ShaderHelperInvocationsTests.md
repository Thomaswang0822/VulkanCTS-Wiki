...
| Leaf registration and test-family factory | [`addShaderHelperInvocationsTests()` and factory](../../../modules/vulkan/shaderexecutor/vktShaderHelperInvocationsTests.cpp#L615-L629) | Registers the six exact leaves under `glsl.helper_invocations`. |

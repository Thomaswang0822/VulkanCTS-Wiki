...
| Registration matrix | [`createPixelConsistencyTests()`](../../../modules/vulkan/fragment_shading_rate/vktFragmentShadingRatePixelConsistency.cpp#L1238-L1319) | Registers all rate, sample, extent, and `zw_coord` combinations. |

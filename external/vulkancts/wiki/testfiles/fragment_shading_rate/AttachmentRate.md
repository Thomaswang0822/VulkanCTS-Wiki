...
| Registration and mode matrix | [`createAttachmentRateTests`](../../../modules/vulkan/fragment_shading_rate/vktAttachmentRateTests.cpp#L2539-L2734) | Exact group names, format/rate values, duplicate cases, and `misc` leaves. |

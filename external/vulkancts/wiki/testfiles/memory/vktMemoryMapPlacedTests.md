...
- **Registration function:** [`createMapPlacedTests()`](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:926)
- **Parent group:** `memory`
...
4. After unmapping, the inspector map verifies:
   ...
   - Guard pages after the Vulkan mapping retain the fill pattern ([vktMemoryMapPlacedTests.cpp:130-433](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:130))
...
3. CPU reads back and verifies `data[i] == i + 1` ([vktMemoryMapPlacedTests.cpp:435-724](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:435))
...
2. `/proc/self/maps` is checked to confirm the reserved range is still covered ([vktMemoryMapPlacedTests.cpp:86-128](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:86))
...
3. `/proc/self/maps` shows the range is still covered ([vktMemoryMapPlacedTests.cpp:726-815](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:726))
...
- `minPlacedMemoryMapAlignment` is queried from `VkPhysicalDeviceMapMemoryPlacedPropertiesEXT` ([vktMemoryMapPlacedTests.cpp:147-154](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:147))
- The test rounds the Vulkan allocation size up to a multiple of this alignment ([vktMemoryMapPlacedTests.cpp:162-164](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:162))

## Support Requirements

| Extension/Feature | Required by |
|-------------------|-------------|
| `VK_EXT_map_memory_placed` | All tests ([vktMemoryMapPlacedTests.cpp:830](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:830)) |
| `VK_KHR_map_memory2` | All tests ([vktMemoryMapPlacedTests.cpp:831](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:831)) |
| `memoryMapPlaced` feature | All tests ([vktMemoryMapPlacedTests.cpp:841-842](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:841)) |
| `memoryUnmapReserve` feature | unmap_reserve, normal_unmap_reserve ([vktMemoryMapPlacedTests.cpp:844-845](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:844), [vktMemoryMapPlacedTests.cpp:907-908](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:907)) |
| Linux/Android with `memfd_create` | All tests ([vktMemoryMapPlacedTests.cpp:139](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:139)) |

## Verification Methods

### Exact address mapping ([vktMemoryMapPlacedTests.cpp:250-258](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:250))
...
### Inspector map verification ([vktMemoryMapPlacedTests.cpp:328-383](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:328))
...
### CPU/GPU round-trip ([vktMemoryMapPlacedTests.cpp:686-702](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:686))
...
### /proc/self/maps verification ([vktMemoryMapPlacedTests.cpp:86-128](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:86))
...
### mmap probe ([vktMemoryMapPlacedTests.cpp:783-801](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:783))
...
- **Re-mapping verification:** After unmap, the test attempts to re-map at the same address and performs a CPU read/write verification (`0xCAFEBABE`) ([vktMemoryMapPlacedTests.cpp:385-419](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:385))
...
- All tests are Linux/Android-only — they require `memfd_create`, `mmap`, and `/proc/self/maps` ([vktMemoryMapPlacedTests.cpp:60-65](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:60))
- The `gpu_access` test uses a single size (65536 bytes) and tests with a buffer bound as a storage buffer to a compute shader
- The test prefers device-local host-visible memory if available, falling back to any host-visible memory type ([vktMemoryMapPlacedTests.cpp:465-469](../../../modules/vulkan/memory/vktMemoryMapPlacedTests.cpp:465))

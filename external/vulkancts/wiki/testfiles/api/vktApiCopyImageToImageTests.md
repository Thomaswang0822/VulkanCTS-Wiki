...
- The `all_formats` and `dimensions` subgroups are skipped when `useSparseBinding` is set — confirmed at [lines 4443–4447](../../../external/vulkancts/modules/vulkan/api/vktApiCopyImageToImageTests.cpp:4443)

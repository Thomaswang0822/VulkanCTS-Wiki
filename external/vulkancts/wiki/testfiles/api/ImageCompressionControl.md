...
| `compressionControlPlaneCount` | `numPlanes` (YCbCr plane count, or `1` for non-YCbCr) when `explicit`; `0` otherwise | Selects which plane the per-plane fixed-rate flags apply to | [`vktApiImageCompressionControlTests.cpp#L453-L454`](../../../modules/vulkan/api/vktApiImageCompressionControlTests.cpp#L453-L454) |

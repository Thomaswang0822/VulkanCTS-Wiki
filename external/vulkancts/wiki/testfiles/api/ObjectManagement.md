...
|-------------|------|----------------|
| Test family registration | [`createObjectManagementTests`](../../../modules/vulkan/api/vktApiObjectManagementTests.cpp#L3601-L4050) | Adds every intermediate node and defines per-leaf `EMPTY_CASE_DESC` exclusions. |

...
| Out-of-pool exhaustion pattern | set-count, descriptors-by-set-count, descriptors-by-binding-count, descriptors-by-array-size, descriptors-by-array-size-across-bindings | Each pattern saturates a different pool capacity field to drive allocation failure. | [vktApiDescriptorPoolTests.cpp#L189-L232](../../../modules/vulkan/api/vktApiDescriptorPoolTests.cpp#L189-L232) |

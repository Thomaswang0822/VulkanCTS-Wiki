...
|-------------|------|----------------|
| Public entry point: `createDeviceInitializationTests()` | [`vktApiDeviceInitializationTests.cpp#L2868-L2942`](../../../modules/vulkan/api/vktApiDeviceInitializationTests.cpp#L2868-L2899) | Builds the `device_init` test family and attaches all 26 intermediate nodes. |
...
| Basic device creation tests | [`vktApiDeviceInitializationTests.cpp#L629-L877`](../../../modules/vulkan/api/vktApiDeviceInitializationTests.cpp#L629-L877) | Bodies for `create_device`, `create_multiple_devices`, `create_device_unsupported_extensions`, `create_device_various_queue_counts`. |
| Queue-priority tests | [`vktApiDeviceInitializationTests.cpp#L879-L1073`](../../../modules/vulkan/api/vktApiDeviceInitializationTests.cpp#L879-L1073) | Priority-valued queue creation and concurrent buffer-fill verification. |
| Global priority tests | [`vktApiDeviceInitializationTests.cpp#L1075-L1392`](../../../modules/vulkan/api/vktApiDeviceInitializationTests.cpp#L1075-L1392) | Bodies and support hooks for the four `create_device_global_priority*` intermediate nodes. |
...
| Unsupported-feature driver: `checkFeatures()` | [`vktApiDeviceInitializationTests.cpp#L1399-L1630`](../../../modules/vulkan/api/vktApiDeviceInitializationTests.cpp#L1399-L1630) | Shared driver for the 220 per-feature leaves, including prerequisite-feature handling. |
...
| `addSeparateUnsupportedFeatureTests()` | [`vkDeviceFeatureTest.inl#L9041-L9042`](../../../framework/vulkan/generated/vulkan/vkDeviceFeatureTest.inl#L8679-L8679) | Generator for the 220 per-feature leaves under `create_device_unsupported_features`. |

...
- The `CompressedTextureForBlit` class uses random data with special valid-block generation for BC6H and ASTC formats to avoid decompression errors �?confirmed at [lines 56�?43](../../../external/vulkancts/modules/vulkan/api/vktApiBlittingTests.cpp:56)

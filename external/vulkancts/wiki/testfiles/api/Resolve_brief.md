...
| `addResolveImageTests` (root registration) | [`vktApiResolveTests.cpp#L2588-L2608`](../../../modules/vulkan/api/vktApiResolveTests.cpp#L2588-L2607) | Adds the 13 intermediate nodes (with `whole_copy_before_resolving_compute` and `_transfer` routed through `addComputeAndTransferQueueTests`). |

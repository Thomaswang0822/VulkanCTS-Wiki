...
| Function category | core, disabled-extension, enabled-extension, non-existent | Each category carries a different nullability expectation under Vulkan's proc-address rules. | [specialCasesCheck()](../../../modules/vulkan/api/vktApiVersionCheck.cpp#L533-L548), [regularCheck()](../../../modules/vulkan/api/vktApiVersionCheck.cpp#L510-L559) |
...
- Regular check: for core functions of every API version at or below the used API version, the proper loader must return a non-null pointer [regularCheck()](../../../modules/vulkan/api/vktApiVersionCheck.cpp#L510-L559).

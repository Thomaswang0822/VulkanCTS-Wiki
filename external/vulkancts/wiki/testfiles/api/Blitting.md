...
| Image type (simple_tests) | 2D (`whole`, `array`, `mirror_xy`, `mirror_x`, `mirror_y`, `mirror_subregions`, `scaling_whole1`, `scaling_whole2`, `scaling_and_offset`, `without_scaling_partial`), 3D (`*_3d` variants plus `mirror_z_3d`), 3D-to-2D-array (`3d_to_2d_array`), 2D-array-to-3D (`2d_array_to_3d`) | Selects `VK_IMAGE_TYPE_2D` or `VK_IMAGE_TYPE_3D`; the two directional cases map array layers and 3D slices in opposite directions. | [`vktApiBlittingTests.cpp#L2755-L2786`](../../../modules/vulkan/api/vktApiBlittingTests.cpp#L2755-L2786), [`vktApiBlittingTests.cpp#L2580-L2727`](../../../modules/vulkan/api/vktApiBlittingTests.cpp#L2580-L2727) |
...
- For compressed destinations, ASTC SFLOAT data is decompressed with `ASTCMODE_HDR`; other compressed formats use LDR mode. See [`vktApiBlittingTests.cpp#L559-L572`](../../../modules/vulkan/api/vktApiBlittingTests.cpp#L559-L572).

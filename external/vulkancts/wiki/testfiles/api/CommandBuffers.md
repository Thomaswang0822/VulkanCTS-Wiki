...
| Large buffer command count | `10000` (`1000` on Vulkan SC) | Drives record_many_* and record_large_secondary. Each iteration records a set/reset event pair. | [`vktApiCommandBuffersTests.cpp#L1164-L1168`](../../../modules/vulkan/api/vktApiCommandBuffersTests.cpp#L1164-L1168) |
...
| Indirect dispatch memory offset | `0, 4, 8, 12, 16, 20, 24, 28` | First axis of the 8×8 generated matrix. The indirect buffer is bound at this offset within an allocated device memory object. | [`vktApiCommandBuffersTests.cpp#L6418-L6428`](../../../modules/vulkan/api/vktApiCommandBuffersTests.cpp#L6418-L6428) |

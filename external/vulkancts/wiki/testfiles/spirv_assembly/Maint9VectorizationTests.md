...
| Operand roles | `result`, `base`, `insert`, `offset`, `count` | Identifies the result buffer and the arguments used by each instruction. | [`BitOp`](../../../modules/vulkan/spirv_assembly/vktSpvAsmMaint9VectorizationTests.cpp#L57-L64), [`TestParams`](../../../modules/vulkan/spirv_assembly/vktSpvAsmMaint9VectorizationTests.cpp#L155-L245) |

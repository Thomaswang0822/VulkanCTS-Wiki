...
- Before registering the vertex, tessellation-control, tessellation-evaluation, and geometry cases, the graphics builder sets `vertexPipelineStoresAndAtomics = true` and `fragmentStoresAndAtomics = false` ([`addGraphicsUboMatrixPaddingTest()`](../../../modules/vulkan/spirv_assembly/vktSpvAsmUboMatrixPaddingTests.cpp#L254-L268)).
- Before registering the fragment case, it sets `vertexPipelineStoresAndAtomics = false` and `fragmentStoresAndAtomics = true` ([`addGraphicsUboMatrixPaddingTest()`](../../../modules/vulkan/spirv_assembly/vktSpvAsmUboMatrixPaddingTests.cpp#L270-L273)).
...
| Group factories | [`createUboMatrixPaddingComputeGroup()` and `createUboMatrixPaddingGraphicsGroup()`](../../../modules/vulkan/spirv_assembly/vktSpvAsmUboMatrixPaddingTests.cpp#L276-L292) | Creates the two `ubo_padding` groups. |
| Parent registration | [parent attachment](../../../modules/vulkan/spirv_assembly/vktSpvAsmInstructionTests.cpp#L21399) and [graphics attachment](../../../modules/vulkan/spirv_assembly/vktSpvAsmInstructionTests.cpp#L21498) | Places the groups below the compute and graphics instruction paths. |

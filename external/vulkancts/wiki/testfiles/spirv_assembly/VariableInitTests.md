...
| Execution path | compute; graphics `vert`, `tessc`, `tesse`, `geom`, `frag`; graphics output `vert` plus `frag` | Varies the shader stage and the interface path while preserving the initializer value. | [`addGraphicsVariableInitPrivateTest`](../../../modules/vulkan/spirv_assembly/vktSpvAsmVariableInitTests.cpp#L263-L349), [`addGraphicsVariableInitOutputTest`](../../../modules/vulkan/spirv_assembly/vktSpvAsmVariableInitTests.cpp#L634-L686) |
...
| Graphics output registration and expected result | [`addGraphicsVariableInitOutputTest`](../../../modules/vulkan/spirv_assembly/vktSpvAsmVariableInitTests.cpp#L634-L686) | Registers the five output cases and their all-ones buffers. |

...
- VulkanSC uses the reduced `MAKE_TEST_SV_*_3_W` macro path for bit-field operations (only `i32`/`u32`); non-VulkanSC uses the broader `MAKE_TEST_SV_*_8136_WN` set covering 8/16/32/64-bit types ([source](../../../modules/vulkan/spirv_assembly/vktSpvAsmTypeTests.cpp#L4032-L4211)).
...
| Operation macros (MAKE_TEST_*) | [`vktSpvAsmTypeTests.cpp#L4032-L4211`](../../../modules/vulkan/spirv_assembly/vktSpvAsmTypeTests.cpp#L4032-L4211) | Macro-expanded registration of every operation across types, vector sizes, and width postfixes |
| `createTypeTests()` | [`vktSpvAsmTypeTests.cpp#L4194-L4208`](../../../modules/vulkan/spirv_assembly/vktSpvAsmTypeTests.cpp#L4194-L4208) | Root registration: builds `scalar`/`vecN` containers and attaches the eight type subgroups |

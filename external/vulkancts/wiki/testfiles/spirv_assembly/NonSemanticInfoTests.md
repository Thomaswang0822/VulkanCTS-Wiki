...
| Assembly generator | [`SpvAsmSpirvNonSemanticInfoBasicCase::initPrograms()`](../../../modules/vulkan/spirv_assembly/vktSpvAsmNonSemanticInfoTests.cpp#L113-L305) | Builds all leaf-specific fragments and the common authored SPIR-V module. |
...
| Family registration | [`createNonSemanticInfoGroup()`](../../../modules/vulkan/spirv_assembly/vktSpvAsmNonSemanticInfoTests.cpp#L312-L340) | Registers the exact eight direct leaves. |
| Common assembly helpers | [Common assembly helpers](../../../modules/vulkan/spirv_assembly/vktSpvAsmComputeShaderTestUtil.cpp#L65-L132) | Defines the common preamble, types, descriptors, and input/output buffers used by the generated module. |
...
| Default mustpass inventory | [Default mustpass inventory](../../../mustpass/main/vk-default/spirv-assembly.txt#L7493-L7500) | Lists the eight Vulkan executable paths. |

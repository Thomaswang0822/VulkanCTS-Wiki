...
- The `fs_depth` buffer is a host-visible Amber comparison artifact, while `depth0` is the depth attachment. Their different expected values are intentional. [Pipeline and expectations](../../../data/vulkan/amber/depth/fs_clamp.amber#L43-L75)
...
- Every case requires `DepthClampZeroOneFeatures.depthClampZeroOne`, which the shared Amber support code recognizes as a feature requirement. Missing requirements cause `NotSupportedError` before execution ([`DepthTestCase::initDeviceCapabilities()`](../../../modules/vulkan/amber/vktAmberDepthTests.cpp#L79-L88), [`AmberTestCase::checkSupport()`](../../../modules/vulkan/amber/vktAmberTestCase.cpp#L204-L287)).
...
| Representative clamp recipe | [`fs_clamp.amber`](../../../data/vulkan/amber/depth/fs_clamp.amber#L15-L75) | Shows shader stages, resources, clamp state, viewport range, draw, and expected values. |
...
| Out-of-range recipes | [`out_of_range.amber`](../../../data/vulkan/amber/depth/out_of_range.amber#L15-L66), [`out_of_range_unrestricted.amber`](../../../data/vulkan/amber/depth/out_of_range_unrestricted.amber#L15-L67) | Contrast `gl_FragDepth = 2.0` with and without `VK_EXT_depth_range_unrestricted`. |
| Bias recipes | [`bias_fs_clamp.amber`](../../../data/vulkan/amber/depth/bias_fs_clamp.amber#L15-L75), [`bias_outside_range.amber`](../../../data/vulkan/amber/depth/bias_outside_range.amber#L15-L74), [`bias_outside_range_fs_clamp.amber`](../../../data/vulkan/amber/depth/bias_outside_range_fs_clamp.amber#L15-L74), [`bias_outside_range_fs_clamp_unrestricted.amber`](../../../data/vulkan/amber/depth/bias_outside_range_fs_clamp_unrestricted.amber#L15-L75) | Define constant-bias values, optional clamp state, and attachment/storage-buffer expectations. |
...
| Required-feature checking | [`AmberTestCase::checkSupport()`](../../../modules/vulkan/amber/vktAmberTestCase.cpp#L204-L287) | Shows that missing declared requirements produce unsupported status before execution. |

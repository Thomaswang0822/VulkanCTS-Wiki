...
- `tess_patch_non_match` cases require `VK_EXT_shader_object` and tessellation shader support at [vktShaderObjectMiscTests.cpp](../../../modules/vulkan/shader_object/vktShaderObjectMiscTests.cpp#L3024-L3028).

...
|-------------|------|----------------|
| Parameter model and format inventory | [Parameter model and format inventory](../../../modules/vulkan/shader_object/vktShaderObjectRenderingTests.cpp#L54-L233) | Defines attachment placement, dummy pass, color-write modes, and the ordinary color format pools. |
| Dynamic attachment list construction | [`ShaderObjectRenderingInstance::beginRendering()`](../../../modules/vulkan/shader_object/vktShaderObjectRenderingTests.cpp#L425-L505) | Places image views and null entries at the locations consumed by fragment outputs. |
| Expected color image | [expected image](../../../modules/vulkan/shader_object/vktShaderObjectRenderingTests.cpp#L552-L601) | Builds format-aware clear values and the rendered center square. |
| Custom device path | [device selection](../../../modules/vulkan/shader_object/vktShaderObjectRenderingTests.cpp#L608-L740) | Removes `VK_EXT_color_write_enable` for the feature-disabled output-array leaf. |
| Main execution path | [`ShaderObjectRenderingInstance::iterate()`](../../../modules/vulkan/shader_object/vktShaderObjectRenderingTests.cpp#L742-L986) | Creates resources and shader objects, records dummy and real rendering, draws, barriers, and copies color images. |
| Color and depth validation | [`ShaderObjectRenderingInstance::iterate()`](../../../modules/vulkan/shader_object/vktShaderObjectRenderingTests.cpp#L988-L1063) | Implements all thresholds, skipped inserted attachments, depth scan, and final status. |
| Support checks | [`ShaderObjectRenderingCase::checkSupport()`](../../../modules/vulkan/shader_object/vktShaderObjectRenderingTests.cpp#L1088-L1126) | Applies extension, attachment-limit, image-format, depth-format, and feature requirements. |
| Shader generator | [`ShaderObjectRenderingCase::initPrograms()`](../../../modules/vulkan/shader_object/vktShaderObjectRenderingTests.cpp#L1128-L1190) | Generates the fixed vertex shader and all separate-output or array fragment shaders. |
| Registration | [`createShaderObjectRenderingTests()`](../../../modules/vulkan/shader_object/vktShaderObjectRenderingTests.cpp#L1199-L1419) | Builds the complete ordinary and output-array matrices and their design exclusions. |
| Shared shader-object helpers | [Shared shader-object helpers](../../../modules/vulkan/shader_object/vktShaderObjectCreateUtil.cpp#L220-L447) | Builds shader create info, sets required dynamic state, and binds graphics stages. |
| Parent registration | [`createTests()`](../../../modules/vulkan/shader_object/vktShaderObjectTests.cpp#L48-L65) | Adds the `rendering` test family under `shader_object`. |
...
| Shader object semantics | [Shader object semantics](../../../../vulkan-docs/src/chapters/shaders.adoc#L46-L60) | Defines per-stage shader objects and their dynamic-state model. |
| Shader object binding and state | [Shader object binding and state](../../../../vulkan-docs/src/chapters/shaders.adoc#L911-L1023) | Defines command-buffer stage binding and the requirement to set relevant dynamic state before drawing. |
| Fragment output interface | [Fragment output interface](../../../../vulkan-docs/src/chapters/interfaces.adoc#L327-L359) | Maps output locations to dynamic-rendering attachment slots. |
| Dynamic rendering | [Dynamic rendering](../../../../vulkan-docs/src/chapters/renderpass.adoc#L9-L46) | Defines dynamic render pass instances and their feature requirement. |
| Depth replacement | [Depth replacement](../../../../vulkan-docs/src/chapters/fragops.adoc#L1003-L1010) | Defines how `FragDepth` replaces calculated fragment depth. |
| Color-write enable | [Color-write enable](../../../../vulkan-docs/src/chapters/framebuffer.adoc#L1914-L1925) | Defines feature-disabled behavior and per-attachment write suppression. |

...
| Category registration boundary | [`createChildren()`](../../../modules/vulkan/binding_model/vktBindingModelTests.cpp#L54-L80) | Registers the family only for Vulkan, not Vulkan SC. |
...
| Queue iteration | [`MultiQueueRunnerTestInstance`](../../../modules/vulkan/vktTestCase.cpp#L1836-L1889) | Runs the case on the available compute-capable queue paths and aggregates failures. |

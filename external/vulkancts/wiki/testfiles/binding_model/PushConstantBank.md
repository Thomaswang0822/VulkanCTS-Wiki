...
| Requested bank count in `descriptor_heap` | `1`, `4`, `8` | Selects the requested active prefix for push-data cases. | [`populateDescriptorHeapTests`](../../../modules/vulkan/binding_model/vktBindingPushConstantBankTests.cpp#L1351-L1378) |
...
- Every leaf requires `VK_KHR_maintenance5`, `VK_KHR_maintenance6`, `VK_NV_push_constant_bank`, and the `pushConstantBank` feature. Maintenance6 is also included in the custom-device extension list. A zero matching bank limit produces `NotSupportedError` ([support checks](../../../modules/vulkan/binding_model/vktBindingPushConstantBankTests.cpp#L1140-L1190), [device extensions](../../../modules/vulkan/binding_model/vktBindingPushConstantBankTests.cpp#L388-L392), [feature definition](../../../../vulkan-docs/src/chapters/features.adoc#L9518-L9538)).
...
| Ordinary runtime | [`runComputeTest` and `runGraphicsTest`](../../../modules/vulkan/binding_model/vktBindingPushConstantBankTests.cpp#L465-L589) | Records pipeline, descriptor, push, execution, barrier, and readback order. |
| Descriptor-heap runtime | [`runComputeDescriptorHeapTest` and `runGraphicsDescriptorHeapTest`](../../../modules/vulkan/binding_model/vktBindingPushConstantBankTests.cpp#L594-L994) | Implements heap sizing, descriptor encoding, mappings, push data, and synchronization directly in this file. |
...
| Generated programs | [`initPrograms`](../../../modules/vulkan/binding_model/vktBindingPushConstantBankTests.cpp#L1215-L1296) | Emits the exact GLSL declarations and result stores. |

...
| Geometry and oracle | [AS creation and `verify()`](../../../modules/vulkan/binding_model/vktBindingDescriptorUpdateASTests.cpp#L642-L724) | Defines the sloped plane and exact expected distance field. |

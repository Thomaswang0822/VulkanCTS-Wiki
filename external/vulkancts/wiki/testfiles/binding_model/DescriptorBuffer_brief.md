...
| Generated case names and expected data | [`getCaseNameUpdateHash()` and `getExpectedData()`](../../../modules/vulkan/binding_model/vktBindingDescriptorBufferTests.cpp#L764-L856) | Connects exact registered suffixes to deterministic shader data. |
| GLSL declarations and checks | [`glslDeclareBinding()` through `glslOutputVerification()`](../../../modules/vulkan/binding_model/vktBindingDescriptorBufferTests.cpp#L907-L1537) | Generates resource interfaces, comparisons, and diagnostic writes. |
| Binding-layout generation | [`DescriptorBufferTestCase::delayedInit()`](../../../modules/vulkan/binding_model/vktBindingDescriptorBufferTests.cpp#L1565-L1882) | Expands each scenario into sets, bindings, arrays, and helper resources. |
...
| Layout size and binding offsets | [`createDescriptorSetLayouts()`](../../../modules/vulkan/binding_model/vktBindingDescriptorBufferTests.cpp#L3326-L3410) | Queries implementation-defined descriptor memory layout. |
| Traditional and sparse descriptor buffers | [`createDescriptorBuffers()`](../../../modules/vulkan/binding_model/vktBindingDescriptorBufferTests.cpp#L3414-L3687) | Creates, allocates, sparsely binds, addresses, and stages descriptor storage. |
| Address and set-offset binding | [`bindDescriptorBuffers()`](../../../modules/vulkan/binding_model/vktBindingDescriptorBufferTests.cpp#L3689-L3815) | Records embedded samplers, buffer addresses, binding indices, and set offsets. |
...
| Registration | [`populateDescriptorBufferTestGroup()` and factory](../../../modules/vulkan/binding_model/vktBindingDescriptorBufferTests.cpp#L7136-L7834) | Defines scenario families, pruning, and three residency intermediate nodes. |

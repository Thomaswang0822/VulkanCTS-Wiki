...
| Category availability | [`createChildren()`](../../../modules/vulkan/binding_model/vktBindingModelTests.cpp#L54-L80) | Places this family under the Vulkan-only registration branch. |
...
| Queue iteration | [`MultiQueueRunnerTestInstance`](../../../modules/vulkan/vktTestCase.cpp#L1836-L1889) | Shows how the test repeats `queuePass()` across available compute-capable queues and aggregates results. |

...
| Build and support availability | source excluded by `CTS_USES_VULKANSC`; runtime requires `VK_EXT_inline_uniform_block` | Removes the family from Vulkan SC builds and skips devices without inline uniform block functionality. | [vktBindingDescriptorInlineUniformTests.cpp](../../../modules/vulkan/binding_model/vktBindingDescriptorInlineUniformTests.cpp#L65-L80), [`checkSupport()`](../../../modules/vulkan/binding_model/vktBindingDescriptorInlineUniformTests.cpp#L669-L702) |

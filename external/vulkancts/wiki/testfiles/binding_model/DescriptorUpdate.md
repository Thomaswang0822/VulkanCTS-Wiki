...
| Build availability | `acceleration_structure` absent under `CTS_USES_VULKANSC` | Keeps the nested acceleration-structure registration out of Vulkan SC builds. | [vktBindingDescriptorUpdateTests.cpp](../../../modules/vulkan/binding_model/vktBindingDescriptorUpdateTests.cpp#L1911-L1916) |

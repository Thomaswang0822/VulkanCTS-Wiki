...
- The selected compute source is added without the local `buildOptions` override, so it inherits the collection's SPIR-V 1.0 baseline ([compute insertion](../../../modules/vulkan/binding_model/vktBindingDescriptorSetRandomTests.cpp#L1102-L1125), [baseline selection](../../../framework/vulkan/vkPrograms.cpp#L1048-L1052), [collection default](../../../modules/vulkan/vktTestPackage.cpp#L547-L553)). The explicit SPIR-V 1.4 options are attached to KHR ray-tracing, task, and mesh programs instead ([explicit option uses](../../../modules/vulkan/binding_model/vktBindingDescriptorSetRandomTests.cpp#L1167-L1413)).

...
The group name is `inline_uniform_blocks`; helper builders add write and copy cases such as size and nonzero-offset variants. Evidence starts at [`vktBindingDescriptorInlineUniformTests.cpp:766`](../../../modules/vulkan/binding_model/vktBindingDescriptorInlineUniformTests.cpp#L766) and continues through [`vktBindingDescriptorInlineUniformTests.cpp:850`](../../../modules/vulkan/binding_model/vktBindingDescriptorInlineUniformTests.cpp#L850).

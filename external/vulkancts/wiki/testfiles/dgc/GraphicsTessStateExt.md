...
| Registration evidence | [dgc source](../../../mustpass/main/vk-default/dgc.txt#L2450-L2649) | Lists the registered `dgc.ext.graphics.tess_state` paths, including regular matrix leaves. |
| Tessellation state specification | [tessellation source](../../../../vulkan-docs/src/chapters/tessellation.adoc#L570-L592) | Defines pipeline patch-control-points state. |
| Dynamic patch-control-points specification | [pipelines source](../../../../vulkan-docs/src/chapters/pipelines.adoc#L6141-L6147) and [shaders source](../../../../vulkan-docs/src/chapters/shaders.adoc#L2585-L2614) | Defines when `VK_DYNAMIC_STATE_PATCH_CONTROL_POINTS_EXT` ignores static state and how `vkCmdSetPatchControlPointsEXT` applies. |

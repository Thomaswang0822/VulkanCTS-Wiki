...
| Device address command path | operation leaves with `_dac` suffix | Uses device-address command variants for the eligible compute/fragment operation cases; host builds and sparse-binding combinations are pruned. | [vktRayQueryAccelerationStructuresTests.cpp:4120-L4168](../../../modules/vulkan/ray_query/vktRayQueryAccelerationStructuresTests.cpp#L4120-L4168) |

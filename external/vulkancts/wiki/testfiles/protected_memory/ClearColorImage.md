...
**Possible implementation causes:** The shared protected image allocation, protected queue selection, command-pool configuration, protected submission, layout dependency, format conversion, descriptor setup, or validator compute path may be responsible. Protected memory is device-only and cannot be combined with host-visible, host-coherent, or host-cached memory types [`memory.adoc`](../../../../vulkan-docs/src/chapters/memory.adoc#L953-L960). The shared failure does not identify `vkCmdClearColorImage` by itself; source-level investigation must isolate the clear from checking infrastructure.
...
| Mustpass paths | [Color-image-clear mustpass cases](../../../mustpass/main/vk-default/protected-memory.txt#L639-L672) | Confirms the 34 primary/secondary static/random paths. |
| `vkCmdClearColorImage` semantics | [`clears.adoc`](../../../../vulkan-docs/src/chapters/clears.adoc#L1-L121) | Defines the clear value, valid layouts, transfer-destination usage, and protected-image rules. |
| Protected memory property | [`memory.adoc`](../../../../vulkan-docs/src/chapters/memory.adoc#L953-L960) | Defines device-only protected memory and host-visibility restrictions. |
| Protected command pools | [`cmdbuffers.adoc`](../../../../vulkan-docs/src/chapters/cmdbuffers.adoc#L318-L340) | Defines protected command buffers allocated from the pool. |

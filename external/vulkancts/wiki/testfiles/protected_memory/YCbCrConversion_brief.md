...
| End-to-end case | [`conversionTest()`](../../../modules/vulkan/protected_memory/vktProtectedMemYCbCrConversionTests.cpp#L1095-L1227) | Creates protected resources and selects compute or fragment validation. |
| Registration matrix | [`createYCbCrConversionTests()`](../../../modules/vulkan/protected_memory/vktProtectedMemYCbCrConversionTests.cpp#L1231-L1354) | Registers format, shader, model, range, chroma-location, and disjoint dimensions. |

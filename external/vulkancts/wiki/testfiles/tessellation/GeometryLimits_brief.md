...
| Limit-family registration | [`createGeometryGridRenderLimitsTests()`](../../../modules/vulkan/tessellation/vktTessellationGeometryGridRenderTests.cpp#L744-L762) | Registers the `limits` family and its three exact leaves. |

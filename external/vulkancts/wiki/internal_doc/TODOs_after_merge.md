...
- [x] `pipeline` — source `37` (A=4, M=33); mustpass `103` (A=95, M=7, D=1). Raw groups: `pipeline`. Decision: complete. All pipeline Level-3 pages reviewed and updated to match upstream source. English files changed: `categories/pipeline.md`, `testfiles/pipeline/Cache.md`, `testfiles/pipeline/PrimitiveRestartIndex.md`, `testfiles/pipeline/InputAssembly.md`, `testfiles/pipeline/InputAttributeOffset.md`, `testfiles/pipeline/VertexInput.md`, `testfiles/pipeline/LegacyAttr.md`, `testfiles/pipeline/NoPosition.md`, `testfiles/pipeline/Library.md`, `testfiles/pipeline/Library_brief.md`, `testfiles/pipeline/Multisample.md`, `testfiles/pipeline/MultisampleImage.md`, `testfiles/pipeline/MultisampleResolveRenderArea.md`, `testfiles/pipeline/MultisampleResolveRenderArea_brief.md`, `testfiles/pipeline/MultisampleSampleLocationsExt.md`, `testfiles/pipeline/MultisampleShaderFragmentMask.md`, `testfiles/pipeline/MultisampledRenderToSingleSampled.md`, `testfiles/pipeline/MultisampledRenderToSingleSampled_brief.md`, `testfiles/pipeline/ExtendedDynamicState.md`, `testfiles/pipeline/ExtendedDynamicState_brief.md`, `testfiles/pipeline/PushDescriptor.md`, `testfiles/pipeline/PushDescriptor_brief.md`, `testfiles/pipeline/Timestamp.md`, `testfiles/pipeline/Timestamp_brief.md`, and `scripts/walkthrough_exceptions.py`. No Chinese pages were modified. Validation passed: mustpass leaf counts confirmed (monolithic 4,288, fast-linked 4,296, shader-object 1,528, emulate_msrtss 32/type), full pipeline registration paths (452 paths), shader-object registration paths (83 paths), and wiki-writer unit suite (50 tests).
  Source evidence:
...
1. [x] Pipeline mustpass layout/validator checks resolved and validated; pipeline category refresh complete. All Level-3 pages reviewed and updated.

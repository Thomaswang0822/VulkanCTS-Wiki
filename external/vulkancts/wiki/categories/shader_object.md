...
- Tessellation and geometry core features recur in multiple branches when those stage combinations are selected, including [`create`](../../modules/vulkan/shader_object/vktShaderObjectCreateTests.cpp#L698-L702), [`link`](../../modules/vulkan/shader_object/vktShaderObjectLinkTests.cpp#L746-L753), [`binary`](../../modules/vulkan/shader_object/vktShaderObjectBinaryTests.cpp#L421-L429), [`pipeline_interaction`](../../modules/vulkan/shader_object/vktShaderObjectPipelineInteractionTests.cpp#L1324-L1333), and [`misc`](../../modules/vulkan/shader_object/vktShaderObjectMiscTests.cpp#L2569-L2574).
...
- [`doc/testspecs/VK/apitests.adoc`](../../../../doc/testspecs/VK/apitests.adoc) was searched during shader-object work and no relevant shader-object-specific section was observed, so this category summary is derived from source evidence rather than test-plan prose.
